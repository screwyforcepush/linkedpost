...
from queryDB import add_to_research_file, get_conductor_key, set_seed_query
...
class BabyAGI(Chain, BaseModel):
    ...
    def _call(
        ...
        first_task = inputs.get("first_task", "Get solution skeleton")
        ...
        while True:
            if self.task_list:
                ...
                add_to_research_file(key=get_conductor_key(),property=f"baby_results", value={"task":task["task_name"],"result":result})
