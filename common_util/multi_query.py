...
DEFAULT_QUERY_PROMPT = PromptTemplate(
        ...
        questions seperated by newlines. Consider the entity information provided, and use relavant information to help generate diverse perspectives.
...
class MultiQueryRetriever(BaseRetriever):
    ...
    def generate_queries(
        ...
        response = self.llm_chain(
            {"question": question, "entities":self.entities}, callbacks=run_manager.get_child()
        )
